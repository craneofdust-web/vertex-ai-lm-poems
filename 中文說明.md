...
- `next_window_stack/backend/`: backend API + static frontend
- `next_window_stack/data/`: local SQLite data
...
- `references/v0.1_notebookLM/`: NotebookLM era (v0.1)
- `references/v0.2_api_results/runs/`: API era outputs (v0.2)
- `references/legacy_handoff/`: previous-window handoff docs
